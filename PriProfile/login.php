        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to GIT</h2><hr>
            ...
            <div class="templatemo-content-widget white-bg col-1">
              ...
              <h3 class="text-uppercase">Bar</h3><hr>
              <div class="progress">
...
$RESULT=$connect->query("SELECT DISTINCT count(CompanyName) from addpdrive where PVenue LIKE '%GIT%' AND YEAR(Date)=YEAR(NOW())");
