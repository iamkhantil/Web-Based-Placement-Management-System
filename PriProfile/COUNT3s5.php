...
{ 
$C10th = $_POST['c10th'];
$RESULT = mysql_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND 10th>='$C10th'");
$data = mysql_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$C10th' in 10th&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysql_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND 10th>='$C10th'");
