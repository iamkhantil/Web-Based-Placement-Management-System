...
{ 
$C12th = $_POST['c12th'];
$RESULT = mysql_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND `12th`>='$C12th'");
$data = mysql_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$C12th' in 12th&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysql_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND `12th`>='$C12th'");
