...
<html lang="en">
  <head>
    ...
    <title>Principal- Company Details</title>
...
$hisofbk = $_POST['hob'];
$dety = $_POST['dy'];
$sql = "SELECT * FROM basicdetails where Approve=1 and Branch='$branch' and 10th>='$10th' and `12th`>='$12th' and BE>='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk' and DetainYears='$dety'" ;
 //run the query
