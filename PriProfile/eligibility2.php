...
<!doctype html>
    ...
    <head>
      ...
      <meta charset="UTF-8">
      <title>Principal- Database Connections</title>
    </head>
    <body>
	<center> <div>
...
$sql = "SELECT * FROM basicdetails WHERE Approve=1 and Branch='$branch' and 10th='$10th' and 12th='$12th' and BE='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk'"; 
...
{         
            ...
            "<tr>"."<td>".$row ['FirstName']."</td>". "</tr>";
             ...
             echo
               "<tr>"."<td>".$row ['10th']."</td>". "</tr>";
             echo
              "<tr>". "<td>".$row ['12th']."</td>". "</tr>";
              echo
               "<tr>"."<td>".$row ['BE']."</td>". "</tr>";
            echo  
