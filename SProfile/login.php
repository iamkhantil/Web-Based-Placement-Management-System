          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li>
                  <a href="../Homepage/index.php">Home GIT</a>
                </li>
                <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to GIT</h2>
              <hr>
              <p>Work is Magic and it defines you at every aspect of your life. As you Work Hard you will become smart and the Irony is Every Smart worker will be a Successfull man where as worthless hardwork is like a monkey finding gold in a sea.
                ...
                target="_parent">Go and Fill yoyour Details in Preferences Tab</a>
                </p>
              <p>We have got number of Partners from the companies who are tied up to our college and it is Incresasing. We are doing our Job of getting you Placed and
                Being a Student its yoyour duty to acompolish your responsibilities.</p>
            </div>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              ...
              <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="https://git.org.in/circulars/">
                      <img class="media-object img-circle" src="images/company.jpg" alt="company">
                    </a>
                  </div>
                  <div class="media-body">
                    <h2 class="media-heading text-uppercase">Upcomming Events</h2>
                    <p>Brace yoyourself for the Events that will take your breath away. Get Started and be a Part of GIT Family</p>
                  </div>
                </div>
              </div>
            </div>
