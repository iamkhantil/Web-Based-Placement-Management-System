      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            ...
            <div class="col-1">
              <div class="templatemo-content-widget Bluegrey-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="RNotif.php">
                      <img class="media-object img-circle" src="images/PN2.png" alt="Read Messages" width="200px" height="200px">
                    </a>
                  </div>
              ...
              <div class="templatemo-content-widget Bluegrey1-bg">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="WNotif.php">
                      <img class="media-object img-circle" src="images/PN1.jpg" alt="Post Notifications" width="175px" height="175px">
                    </a>
                  </div>
                  <div class="media-body">
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2020 Gandhinagar Institute of Technology|
                    Developed by
                    <a title="Designer" target="_blank" href="https://iamkhantil.github.io/"><img alt="Developer" src="../Homepage/img-logo.png" class=""></a>          </footer>
        </div>
      </div>
    </div>
