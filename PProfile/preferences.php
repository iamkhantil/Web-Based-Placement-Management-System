...
<html lang="en">
  ...
  <head>
    ...
    <title>Placement- Update Your Details</title>
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li>
              <a href="Placement Drives.php"><i class="fa fa-bar-chart fa-fw"></i>Placement Drives</a>
            </li>
            <li>
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li>
                  <a href="../Drives/index.php">Drives</a>
                </li>
                <li>
            ...
            <form action="pref.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="Fname" class="form-control" id="inputFirstName" placeholder="khantil">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <label for="inputLastName">Last Name</label>
                  <input type="text"  name="Lname" class="form-control" id="inputLastName" placeholder="khokhani">
                </div>
