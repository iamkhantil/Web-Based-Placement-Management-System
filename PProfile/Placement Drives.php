...
<?php
      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../Homepage/index.php">Home GIT</a></li>
        ...
        <div class="templatemo-content-container">
            ...
            <div class="col-1">
              <div class="templatemo-content-widget orangee-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body"><a href="Placement Drives/addpdrive.php">
                    <h2 class="media-heading text-uppercase">Add Placement Drives</h2></a>
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                  	<a href="Placement Drives/update.php">
                    <h2 class="media-heading text-uppercase">Update Drive Details</h2></a><p>Update the Details of Drives happened and the Status of Students </p>
                  </div>
                </div>
              </div>
                ...
                <div class="media">
                  ...
                  <div class="media-body"><a href="Placement Drives/Companydetails.php">
                    <h2 class="media-heading text-uppercase">Company Details</h2></a>
                ...
                <div class="media">
                  ...
                  <div class="media-body"><a href="Placement Drives/drivehome.php">
                    <h2 class="media-heading text-uppercase">Drive Details</h2></a>
              ...
              <div class="templatemo-content-widget orangge-bg">
                <i class="fa fa-times"></i>
                <div class="media">
                  <div class="media-left"><a href="Placement Drives/PUpload.php">
                      <img class="media-object img-circle" src="images/UI.png" alt="Sunset" width="100px" height="100px">
                  </a>
                  </div>
                  <div class="media-body"><a href="Placement Drives/PUpload.php">
                    <h2 class="media-heading text-uppercase">Upload Image to Gallery</h2></a>
          ...
          <footer class="text-right"><p>Copyright &copy; 2020 Gandhinagar Institute of Technology|
                    Developed by
