				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>The lush green campus of GIT is located on the outskirts of Ahmedabad / Gandhinagar, is in complete harmony with nature. The picturesque location provides a refreshing environment in which students can pursue their studies peacefully and undisturbed. A place, where tranquility acquires a new dimension and where modern architecture blends with traditional values to heighten the spirit of continuous learning.
GIT has state of the art laboratories which are spacious and well equipped with all necessary instruments, Wi-Fi enabled campus, Resource Centre, Transportation facility, Students’ Store, Sports’ Ground, and Open Air Theatre.</p>
					</div>
