				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">GIT<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
...
Institute Industry Interaction Cell at our Institute is headed by the Training and Placement Officer guided by the Director of the Institute and assisted by the Student Placement Coordinators.

The Institute Industry Interaction Cell @GIT follows a three pronged approach where we believe in strong Industry Interface to enable students have exposure of industries.
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of GIT</h3>
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers B.E. Program in Mechanical Engineering, Computer Engineering, Information Technology, Electronics & Communication Engineering, Electrical Engineering and Civil Engineering. It also offers M.E. in Mechanical Engineering with specialization in Thermal Engineering and CAD / CAM and M.E. in Software Engineering in Computer Engineering. It also offers MBA Program with specialization in Marketing, Finance, Human Resource and Information Technology. Gandhinagar Institute of Technology will nurture the intellectual growth of its students and serve humanity through creation, application and dissemination of knowledge relevant to technology and become one of the premier Engineering and Management Institutes and achieve the highest order of excellence in teaching. 
					</p>
				</div>
				<div class="col-md-6 about-bottom-left about-bottom-right wow fadeInRight animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>We Promote</h4>
					<p>We wish to bring to your kind notice that for promoting the campus employment opportunities for students of the Engineering Colleges located in the rural areas, we have formed a joint understanding with many other Institutions on full commitment basis. 
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>GIT, Khatraj Kalol Road
							<span>Moti Bhoyan, Gandhinagar</span>
						</p>
					</div>
					<div class="phone">
						<p>+91 9904405900 / 01</p>
					</div>
				</div>
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Gandhinagar Institute of Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2020 Gandhinagar Institute of Technology | Developed by
